 ...
 * 如何使用：
 * 
 * 在 https://work.weixin.qq.com/wework_admin/frame#/apps/contactsApi 开启API接口同步
 * 权限 只读或编辑 均可
 * 获取 Secret 和 CorpID
 * 
 * 在 Workers KV 创建一个命名空间，名称随意
 * 创建一个 Worker，绑定上面创建的命名空间，变量名称填写为 WorkerKV
 * 在该 Worker 添加环境变量 WECOM_CORPID 和 WECOM_CORPSECRET 对应你的信息
 * 快速编辑将代码粘贴保存
 * 
